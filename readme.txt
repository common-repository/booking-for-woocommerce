...
doctor appointment, renting items and many more.
...
* Multi Currency Plugins Support
...
== Changelog ==
= 4.3.1 =
* [Bug fix] Variable type product issues
= 4.3.0 =
* [Bug fix] Availability Rule issues fixed

= 4.2.2 =
* [Bug fix]  removed unwanted character from text 'Total' from version 4.2.1
* WooCommerce 6.4 Support
= 4.2.1 =
* Bug Fixes
* Multi Currency Plugins support
* Time Picker Format Option
= 4.2.0 =
* Bug Fixes
* Freemius SDK update
* WooCommerce 6.3.1 Support
* WordPress 5.9.0 support
= 4.1.0 =
* Bug Fixes
* WooCommerce 5.6.x Support
* WordPress 5.8.0
= 4.0.1 =
* Bug Fixes
* Code optimizations
